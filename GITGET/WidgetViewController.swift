...
class WidgetViewController: UIViewController {
    ...
    func selectTutorialImageForIPhoneHeight(of height:CGFloat) {
        switch height {
        case 812.0: //iPhone X
            self.tutorialImageView.image = UIImage(named: "TutorialThree_en_iPhoneX".localized)
            self.tutorialImageViewBottomConstraint.constant = 0
            self.tutorialImageViewTrailingConstraint.constant = 0
        case 568.0: //iPhone SE
            self.tutorialImageView.image = UIImage(named: "TutorialThree_en_iPhoneSE".localized)
        default:
            self.tutorialImageView.image = UIImage(named: "TutorialThree_en_iPhone".localized)
        }
    }
}
